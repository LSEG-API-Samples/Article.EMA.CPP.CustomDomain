...
int main( int argc, char* argv[] )
{
	try {
		...
		handle = consumer.registerClient(ReqMsg().domainType(MMT_CUSTOM).interestAfterRefresh(false).serviceName("INTERNAL_FEED").name(client.fileName), client, &(outFileStream));
